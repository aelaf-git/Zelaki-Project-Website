      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex py-12 justify-center text-white items-center px-20 sm:px-36">
          <div className="relative">
            <h2 className="font-bold text-xl pr-5 relative z-50">Skilline</h2>
            <svg
        ...
        <div className="text-center pb-16 pt-5">
          ...
          <div className="px-5 sm:px-0 flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0 justify-center mt-3">
            <input
              ...
              className="rounded-full py-2 pl-5 bg-transparent border border-gray-400 text-white placeholder-gray-400 focus:outline-none"
            />
            <button
              type="submit"
          ...
          <div className="py-3 tracking-wide">
            <p>
              ...
              <span className="font-semibold">
                <a href="https://github.com/mhaecal/" target="_blank" rel="noopener noreferrer">mhaecal</a>
              </span>
            </p>
