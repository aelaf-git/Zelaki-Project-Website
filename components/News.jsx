    ...
    <>
      ...
      <div className="my-14 flex flex-col lg:flex-row lg:space-x-20">
        ...
        <div className="lg:w-6/12">
          <Image className="w-full mb-6 h-auto rounded-xl" src="/img/laptop-news.png" alt="Latest news" width={600} height={400} />
            ...
            <div key={i} className="flex space-x-5">
              <div className="w-4/12">
                <div className="relative">
                  <Image className="rounded-xl w-full h-auto" src={article.img} alt={article.alt} width={200} height={150} />
